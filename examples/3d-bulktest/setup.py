...
parser.add_argument('--shape', type=str, help='shape of grain', default='sphere')
...
retaintion_ratio = 0.5
# retaintion_ratio = 0.9
msh.trim(min_rad = (1-retaintion_ratio)*1e-3 + min_particle_spacing/2, max_rad = (1+retaintion_ratio)*1e-3 + min_particle_spacing/2)
msh.info()
...
# done bulk generation
####

SL.append(shape=shape, count=msh.count(), meshsize=meshsize, material=material)
