...
SL = ShapeList()
shape=shape_dict.randomConvex3d()

#shape=shape_dict.randomConvex3d(8,r_sphere=rad,meshsize=meshsize)
#shape=shape_dict.cube_3d()
...
#SL.append(shape=shape_dict.cube_3d(), count=2, meshsize=meshsize, material=material_dict.peridem_3d(delta))
...
particles = SL.generate_mesh(dimension = 3, contact_radius=contact_radius, plot_node_text=False,plot_shape = True)
