...
gen_plot(){
    ...
    # cmap='Greys'
    cmap='viridis'
    python3 plot3d_timestep.py --data_dir $dir --img_dir $dir --setup_file $sfile --dotsize $dotsize --quantity $qq --nocolorbar --colormap $cmap --view_az $view_az --view_angle $view_angle  #--plot_bonds --bond_linewidth ${bond_linewidth} --fc $fcval
    # python3 plot3d_timestep.py --all_dir $dir --dotsize $dotsize
    # python3 plot3d_timestep.py --all_dir $dir --dotsize $dotsize --view_az $view_az --view_angle $view_angle
    echo "$dir"
    sxiv $dir/*.png &
}
