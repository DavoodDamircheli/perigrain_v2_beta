...
plank_L =  5 * rad
plank_h =  rad/4
plank_drop_from = 2 * rad
plank = shape_dict.box_3d(xyz=[-plank_L/2, -plank_L/2, plank_drop_from-plank_h/2], L1=plank_L, L2=plank_L, L3=plank_h, meshsize=0.1e-3, meshdata_dir='meshdata', filename_suffix='00')
...
SL.append(shape=plank, count=1, meshsize=meshsize, material=material)
...
# plank
particles[1][0].vel += [0, 0, args.vel_val]
particles[1][0].acc += [0, 0, args.acc_val]
