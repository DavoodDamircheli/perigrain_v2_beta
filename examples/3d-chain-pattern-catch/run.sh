...
gen_plot(){
    ...
    # python3 plot3d_timestep.py --all_dir $dir --dotsize $dotsize --view_az $view_az --view_angle $view_angle --alpha $alpha

    python3 plot3d_timestep.py --all_dir $dir --dotsize $dotsize --view_az $view_az --view_angle $view_angle --motion --motion_angle_stepsize 0.1
    echo "$dir"
    sxiv $dir/*.png &
}
