...
material = material_dict.kalthoff3d(delta, K_scale=1, Gnot_scale=5e3)

SL.append(shape=shape, count=2, meshsize=1, material=material)
...
particles = SL.generate_mesh(dimension = 3, contact_radius=contact_radius, plot_mesh=(not args.noplot), plot_node_text=False)
