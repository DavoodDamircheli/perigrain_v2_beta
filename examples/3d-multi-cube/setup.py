...
SL.append(shape=shape, count=7, meshsize=meshsize, material=material)
...
particles[0][2].rotate3d('z', -np.pi/2)
particles[0][0].shift([0, 0.3*rad+contact_radius*1.1,                     0])
#  (x,y,z)---> y = movehorizontally, z = moving vertically
particles[0][1].shift([0, 0                       , 1*rad+contact_radius*1.1])
particles[0][2].shift([0,0.3*rad+contact_radius*1.1, 2.5*rad+contact_radius*1.1])
particles[0][3].shift([1*rad+contact_radius*1.1,-1*rad+contact_radius*1.1, 3.0*rad+contact_radius*1.1])
...
plot3d_setup(particles, dotsize=20, wall=wall, show_particle_index=True, delta=delta, contact_radius=contact_radius)
