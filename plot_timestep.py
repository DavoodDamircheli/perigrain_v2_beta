...
parser.add_argument('--bond_linewidth', type=float, help='line width of bonds', default=0.1)
...
parser.add_argument('--plot_bonds', action='store_true', help='plot all bonds')
    ...
    for name in f:
        if re.match(r'P_[0-9]+', name):
            ...
            if args.plot_bonds:
                ...
                lc = LineCollection(ls, linewidths=args.bond_linewidth, colors='b')
